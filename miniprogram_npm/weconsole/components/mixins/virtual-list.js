    ...
    methods: {
        ...
        $vlComputeItemHeight(id) {
            ...
            if (!this.$vlItemHeightComputeMap[id]) {
                this.$vlItemHeightComputeMap[id] = this.$getBoundingClientRect(`.vl-item-${id}`).then((res) => {
                    if ((this === null || this === void 0 ? void 0 : this.$vlItemHeightComputeMap) && this.$vlItemHeightComputeMap[id]) {
        ...
        $vlComputeContainerHeight(callback) {
            ...
            this.$getBoundingClientRect(this.data.$vlContainerSelector).then((res) => {
                ...
                (this === null || this === void 0 ? void 0 : this.$vlOnContainerHeightComputed) && this.$vlOnContainerHeightComputed();
                callback === null || callback === void 0 ? void 0 : callback(res.height);
                if (!this.$vlContainerHeightComputeing) {
                    return;
                }
                delete this.$vlContainerHeightComputeing;
                if ((this === null || this === void 0 ? void 0 : this.$vlContainerHeightComputeQueue) && this.$vlContainerHeightComputeQueue.length) {
                    const last = this.$vlContainerHeightComputeQueue.pop();
                    this.$vlContainerHeightComputeQueue.forEach((item) => {
                        item === null || item === void 0 ? void 0 : item(res.height);
                    });
        ...
        $vlComputeShowList() {
            ...
            this.$vlComputeShowListTimer = setTimeout(() => {
                ...
                const vlGetItemHeight = this.$vlGetItemHeight ? this.$vlGetItemHeight : () => { };
                ...
                const staticHeight = this.data.$vlItemStaticHeight && typeof this.data.$vlItemStaticHeight === 'number'
        ...
        $vlSetShowList(startIndex, endIndex) {
            ...
            const needUpdate = vlStartIndex !== this.$vlStartIndex ||
            ...
            if (needUpdate) {
                ...
                const staticHeight = this.data.$vlItemStaticHeight && typeof this.data.$vlItemStaticHeight === 'number'
                    ? this.data.$vlItemStaticHeight
                    : null;
                const precutHeight = this.data.$vlItemPrecutHeight && typeof this.data.$vlItemPrecutHeight === 'number'
        ...
        $vlSaveItemState(itemId, state, replace = false) {
            if (!this.$vlItemState) {
                this.$vlItemState = {};
            }
            if (replace || !this.$vlItemState[itemId]) {
                ...
                this.$vlItemState[itemId] = Object.assign(Object.assign({}, this.$vlItemState[itemId]), state);
            }
        },
        $vlRestoreItemState(itemId) {
            if ((this === null || this === void 0 ? void 0 : this.$vlItemState) && this.$vlItemState[itemId] && this.$vlItemRestorePolicy) {
