...
const Spec = {
    ...
    methods: {
        ...
        onWcProduct(type, data) {
            var _a;
            if (data.type === "Api" /* Api */ || ((_a = this === null || this === void 0 ? void 0 : this.materialExist) === null || _a === void 0 ? void 0 : _a[data.id])) {
        ...
        gridReady(e) {
            ...
            if (this.ApiStateController) {
                ...
                this.$DataGridMain.onScroll((top) => {
        ...
        tapGridCell(e) {
            ...
            if (rowId) {
                this.setDetailMaterial(rowId, null, 'tapCell'
        ...
        copyMaterial(m) {
            ...
            if (this === null || this === void 0 ? void 0 : this.$wcUIConfig.copyPolicy) {
        ...
        syncGridPageSize() {
            ...
            if (grid) {
                Promise.all([rpxToPx(40), grid.$getBoundingClientRect('.fc-datagrid-scroll')]).then(([itemHeight, { height }]) => {
                    this.setData({
    ...
    created() {
        ...
        this.ApiStateController = wcScopeSingle('ApiStateController');
        this.$wcOn("WcMainComponentSizeChange" /* WcMainComponentSizeChange */, () => {
