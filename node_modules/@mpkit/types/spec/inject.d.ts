...
import { MpViewAppSpec, MpViewPageSpec, MpViewComponentSpec, MpView } from "./view";
import { MkSetDataOptions } from "./set-data";
import { MkMixinStore } from "./mixin";
export interface MpKitPlugin {
    name: string;
    apply(mpkit: MpKitInject, config?: any): any;
}
...
export interface MpKitInject extends EBus {
    App(...specList: MpViewAppSpec[]): any;
    Page(...specList: MpViewPageSpec[]): any;
    Component(...specList: MpViewComponentSpec[]): any;
