...
export interface IMkMpXmlAttrParseAdapter {
    parse(attr: FxNodeJSON, parent?: FxNodeJSON | LikeFxParseContext, grandpa?: FxNodeJSON | LikeFxParseContext): MkXmlNode;
}
export interface IMkMpXmlContentParseAdapter {
    parse(content: string, node?: FxNodeJSON, parent?: FxNodeJSON | LikeFxParseContext, grandpa?: FxNodeJSON | LikeFxParseContext): MkXmlContent[];
}
...
export interface MkXmlNodeJSON extends MkOmit<FxNodeJSON, "attrs" | "children"> {
    attrs?: MkXmlNodeJSON[];
...
export interface MkXmlNode extends MkOmit<MkXmlNodeJSON, "attrs" | "children" | "parent"> {
    attrs?: MkXmlNode[];
    children?: MkXmlNode[];
    mpContents?: MpForAttrContent[] | MkXmlContent[];
    parent?: MkXmlNode;
...
export interface MkNodeSerializer {
    (nodes: FxNodeJSON[], handler: MkNodeSerializeHandler, parentNode?: FxNodeJSON): string;
}
export interface MkNodeSerializeHandler {
    (currentNode: MkXmlNodeJSON, brotherNodes: MkXmlNodeJSON[], rootNodes: MkXmlNodeJSON[], rootSerializer: MkNodeSerializer, parentNode: FxNodeJSON, adapter: FxNodeAdapter, serializeResult: string): string;
}
