import { MkMpXmlParseOptions, MkMpXmlSerializeOptions, MkXmlNodeJSON } from "./mpxml-parser";
...
export interface MkTranslateAdapter<T = any> {
    match(sourcePlatform: MpPlatform | string, targetPlatform: MpPlatform | string): boolean;
